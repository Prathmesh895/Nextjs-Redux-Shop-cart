...
import   useSyncCartAcrossTabs from '@/components/synckedtab'
              ...
              <div className="block lg:hidden">
                {cartItems.map((item) => (
                  <div key={item.id} className="border-b p-4 flex flex-col items-center">
                    ...
                    <div className="py-2 font-semibold">{item.price * item.quantity}</div>
                  ...
                  <tbody>
                    {cartItems.map((item) => (
                      <tr key={item.id} className="border-b">
                        ...
                        <td className="py-2 px-4 font-semibold">{item.price * item.quantity}</td>
                        <td className="py-2 px-4">
                          <button
                            className="bg-gray-200 rounded-full py-1 px-3 mr-2"
                            onClick={() => handleIncrement(item.id)}
